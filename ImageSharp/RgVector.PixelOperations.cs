...
public partial record struct RgVector {

  /// <summary>
  /// <see cref="PixelOperations{TPixel}"/> implementation optimized for <see cref="RgbaVector"/>.
  /// </summary>
  private class PixelOperations : PixelOperations<RgVector> {
    ...
    public override void From<TSourcePixel>(
      ...
      Span<RgVector> destinationPixels) {
    ...
    public override void ToVector4(
      Configuration configuration,
      ReadOnlySpan<RgVector> sourcePixels,
