...
public partial record struct RgHalfVector {

  /// <summary>
  /// <see cref="PixelOperations{TPixel}"/> implementation optimized for <see cref="RgbaVector"/>.
  /// </summary>
  private class PixelOperations : PixelOperations<RgHalfVector> {

    private static readonly PixelTypeInfo PixelTypeInfo
      = new(32 * 2, PixelAlphaRepresentation.None);
    ...
    public override void From<TSourcePixel>(
      ...
      Span<RgHalfVector> destinationPixels) {
    ...
    public override void ToVector4(
      Configuration configuration,
      ReadOnlySpan<RgHalfVector> sourcePixels,
