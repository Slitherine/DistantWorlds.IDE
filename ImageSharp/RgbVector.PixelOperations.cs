...
public partial record struct RgbVector {

  /// <summary>
  /// <see cref="PixelOperations{TPixel}"/> implementation optimized for <see cref="RgbaVector"/>.
  /// </summary>
  private class PixelOperations : PixelOperations<RgbVector> {
    ...
    public override void From<TSourcePixel>(
      ...
      Span<RgbVector> destinationPixels) {
    ...
    public override void ToVector4(
      Configuration configuration,
      ReadOnlySpan<RgbVector> sourcePixels,
