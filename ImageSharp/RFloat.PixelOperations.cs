...
public partial record struct RFloat {
  ...
  private class PixelOperations : PixelOperations<RFloat> {
    ...
    public override void ToVector4(
      Configuration configuration,
      ReadOnlySpan<RFloat> sourcePixels,
